...
Backup functionality has been added to Intel&reg; AI for Enterprise RAG to offer protection and reduce downtime in case of accidents.<br>
* See [User Data Backup](../docs/backup.md) document for an overview and quick start guide for this feature.
* See [Velero Component Readme](components/velero/README.md) document for configuration details and in-depth overview of the backup and restore operations.
