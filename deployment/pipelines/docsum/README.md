...
| `reference-xpu.yaml`                         | Intel XPU | A Docsum pipeline powered by the Intel XPU backend that processes documents through TextExtractor, TextCompression, TextSplitter, and generates summaries using VLLM (XPU) and LLM services. |
