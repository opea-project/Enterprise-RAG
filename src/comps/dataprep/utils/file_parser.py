...
class FileParser:
    ...
    def default_mappings(self):
        return [
            ...
            {'file_type': 'json',  'loader_file_name': 'load_json',  'loader_class': 'LoadJson',     'mime_type': 'application/json, text/plain'},
            {'file_type': 'jsonl', 'loader_file_name': 'load_json',  'loader_class': 'LoadJson',     'mime_type': 'application/x-ndjson'},
            {'file_type': 'csv',   'loader_file_name': 'load_csv',   'loader_class': 'LoadCsv',      'mime_type': 'text/csv, text/plain'},
            ...
            {'file_type': 'html',  'loader_file_name': 'load_html',  'loader_class': 'LoadHtml',     'mime_type': 'text/html, text/plain'},
            {'file_type': 'md',    'loader_file_name': 'load_md',    'loader_class': 'LoadMd',       'mime_type': 'text/plain'},
            {'file_type': 'xml',   'loader_file_name': 'load_xml',   'loader_class': 'LoadXml',      'mime_type': 'text/xml, text/plain'},
