...
3. [Summary Types](#summary-types)
4. [Getting Started](#getting-started)
   - 4.1. [Prerequisite: Start LLM Microservice](#prerequisite-start-llm-microservice)
   - 4.2. [🚀 Start Document Summarization Microservice with Python (Option 1)](#-start-document-summarization-microservice-with-python-option-1)
     - 4.2.1. [Install Requirements](#install-requirements)
     - 4.2.2. [Start Microservice](#start-microservice)
   - 4.3. [🚀 Start Document Summarization Microservice with Docker (Option 2)](#-start-document-summarization-microservice-with-docker-option-2)
     - 4.3.1. [Build the Docker Image](#build-the-docker-image)
     - 4.3.2. [Run the Docker Container](#run-the-docker-container)
   - 4.4. [Verify the Document Summarization Microservice](#verify-the-document-summarization-microservice)
