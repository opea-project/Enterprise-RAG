...
1. [TorchServe Reranks Model Server](#torchserve-reranks-model-server)
2. [Getting Started](#getting-started)
   ...
   - 2.3. [🚀 Deploy TorchServe Service with Reranks Microservice using Docker Compose (Option 2)](#-deploy-torchserve-service-with-reranks-microservice-using-docker-compose-option-2)
...
### 🚀 Deploy TorchServe Service with Reranks Microservice using Docker Compose (Option 2)
