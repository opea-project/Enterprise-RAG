...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "nri-balloons-controller.intel.com",
	})
	if err != nil {
	...
	podMutator := &pod.PodMutator{
		...
		Log:    ctrl.Log.WithName("webhook").WithName("pod"),
	}

	if podMutator.Client == nil {
		setupLog.Error(nil, "pod mutator client is nil")
		os.Exit(1)
	}

	// Create decoder and inject it manually
	...
	// Register the webhook - use the handler directly since decoder is already injected
