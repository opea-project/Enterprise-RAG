...
def test_get_connector_succeeds_for_langchain(MockLangchainLLMConnector, sut_model_server_name, reset_singleton, mock_connector_validate):
    ...
    MockLangchainLLMConnector.assert_called_once_with(sut_instance._model_name, sut_instance._model_server, sut_instance._model_server_endpoint, False, True, False, {})
...
def test_get_connector_succeeds_for_generic(MockGenericLLMConnector, sut_model_server_name, reset_singleton, mock_connector_validate):
    ...
    MockGenericLLMConnector.assert_called_once_with(sut_instance._model_name, sut_instance._model_server, sut_instance._model_server_endpoint, False, True, False, False, {})
