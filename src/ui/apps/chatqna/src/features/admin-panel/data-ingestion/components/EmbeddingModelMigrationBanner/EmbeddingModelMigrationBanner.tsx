...
const EmbeddingModelMigrationBanner = () => {
  const migrationRequired =
    getChatQnAAppEnv("EMBEDDING_MODEL_MIGRATION_REQUIRED") === "true";
  const oldModel = getChatQnAAppEnv("EMBEDDING_MODEL_MIGRATION_OLD_MODEL");
  const newModel = getChatQnAAppEnv("EMBEDDING_MODEL_MIGRATION_NEW_MODEL");
