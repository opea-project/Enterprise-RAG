...
import { ServiceArgumentInputValue } from "@/types/index";
...
export interface LLMOutputGuardArgs extends Record<
  string,
  Record<string, ServiceArgumentInputValue>
> {
...
export const defaultLLMOutputGuardEnabledScanners: (keyof typeof llmOutputGuardFormConfig)[] =
  ["ban_substrings", "code", "bias", "relevance", "malicious_urls"];
