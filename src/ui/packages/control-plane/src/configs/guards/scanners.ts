...
export const banTopicsScanner = { enabled, threshold, topics };
...
export const tokenLimitScanner = { enabled, limit };
...
export interface BanSubstringsScannerArgs extends Record<
  string,
  ServiceArgumentInputValue
> {
...
export interface CodeScannerArgs extends Record<
  string,
  ServiceArgumentInputValue
> {
  enabled: ServiceArgumentCheckboxValue;
...
export interface InvisibleTextScannerArgs extends Record<
  string,
  ServiceArgumentInputValue
> {
  enabled: ServiceArgumentCheckboxValue;
...
export interface BiasScannerArgs extends Record<
  string,
  ServiceArgumentInputValue
> {
  enabled: ServiceArgumentCheckboxValue;
...
export interface RelevanceScannerArgs extends Record<
  string,
  ServiceArgumentInputValue
> {
  enabled: ServiceArgumentCheckboxValue;
...
export interface MaliciousURLsScannerArgs extends Record<
  string,
  ServiceArgumentInputValue
> {
  enabled: ServiceArgumentCheckboxValue;
...
export interface PromptInjectionScannerArgs extends Record<
  string,
  ServiceArgumentInputValue
> {
  enabled: ServiceArgumentCheckboxValue;
...
export interface RegexScannerArgs extends Record<
  string,
  ServiceArgumentInputValue
> {
  enabled: ServiceArgumentCheckboxValue;
...
export interface BanTopicsScannerArgs extends Record<
  string,
  ServiceArgumentInputValue
> {
  enabled: ServiceArgumentCheckboxValue;
...
export interface SecretsScannerArgs extends Record<
  string,
  ServiceArgumentInputValue
> {
  enabled: ServiceArgumentCheckboxValue;
...
export interface SentimentScannerArgs extends Record<
  string,
  ServiceArgumentInputValue
> {
  enabled: ServiceArgumentCheckboxValue;
...
export interface TokenLimitScannerArgs extends Record<
  string,
  ServiceArgumentInputValue
> {
  enabled: ServiceArgumentCheckboxValue;
...
export interface ToxicityScannerArgs extends Record<
  string,
  ServiceArgumentInputValue
> {
  enabled: ServiceArgumentCheckboxValue;
