...
import { containsRequiredValues, noEmpty } from "@/utils/validators/textInput";
...
const promptTemplateValidationSchema = object().shape({
...
export default promptTemplateValidationSchema;
